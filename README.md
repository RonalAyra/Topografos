# [Colegio de Topografos de Bolivia](https://soft-ui-dashboard-laravel.creative-tim.com/login)
...
Colegio de Topografos de Bolivia comes with dozens of handcrafted UI elements tailored for Bootstrap 5 and an out of the box Laravel backend.
...
Whether you're working on a side project or delivering to a client, we've got you covered. Colegio de Topografos de Bolivia is released under MIT license, so you can use it both for personal and commercial projects for free. All you need to do is start coding. 


## Detailed documentation and example pages
We also included detailed documentation for every component and feature so you can follow along. The pre-built example pages give you a quick glimpse of what Colegio de Topografos de Bolivia has to offer so you can get started in no time. 
...
## Documentation
The documentation for the Colegio de Topografos de Bolivia is hosted at our [website](https://soft-ui-dashboard-laravel.creative-tim.com/documentation/getting-started/overview.html).
